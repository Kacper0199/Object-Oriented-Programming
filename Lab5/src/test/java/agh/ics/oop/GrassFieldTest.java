...
public class GrassFieldTest{
    ...
    public void canMoveToTest(){
        ...
        // when
        map.place(animal);
        map.grassFields.add(grass1);
        map.grassFields.add(grass2);
    ...
    public void placeTest(){
        ...
        Animal animal3 = new Animal(map, new Vector2d(Integer.MAX_VALUE, Integer.MAX_VALUE));
        Animal animal4 = new Animal(map, new Vector2d(Integer.MIN_VALUE, Integer.MIN_VALUE));
        Animal animal5 = new Animal(map, new Vector2d(Integer.MAX_VALUE, Integer.MAX_VALUE));
        Animal animal6 = new Animal(map, new Vector2d(Integer.MIN_VALUE, Integer.MIN_VALUE));
        Animal animal7 = new Animal(map, new Vector2d(0, 0));
        Grass grass1 = new Grass(new Vector2d(-5, -5));
        Grass grass2 = new Grass(new Vector2d(0, 0));
